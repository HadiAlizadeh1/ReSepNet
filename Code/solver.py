...
from pit_criterion3 import cal_loss3
from pit_criterion2 import cal_loss2 


class TransformerOptimizer(object):
    """A simple wrapper class for learning rate scheduling"""

    def __init__(self, optimizer, k=0.2, d_model=64, warmup_steps=4000):
...
class Solver(object):
    ...
    def _run_one_epoch(self, epoch, cross_valid=False):
        ...
        for i, (data) in enumerate(data_loader):
            ...
            padded_mixture, mixture_lengths, padded_source,num = data
            ...
            if num == 2 :
              ...
              if self.use_cuda:
                  ...
                  padded_source = padded_source[:,0:2,:].cuda()
              estimate_source = self.model(padded_mixture)
              Loss = \
                  cal_loss2(padded_source, estimate_source, mixture_lengths)
            ...
            if num == 3 :
              ...
              loss1,loss_remaind,source = \
                  cal_loss3(padded_source, estimate_source, mixture_lengths)
            
              Iter_2_estimate_source = self.model(estimate_source[:,1,:])
              loss2 =\
                  cal_loss2(source, Iter_2_estimate_source, mixture_lengths)

              
              Loss = (loss1,loss_remaind/2) + (loss2)
